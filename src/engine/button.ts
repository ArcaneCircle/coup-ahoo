...
export class ButtonEntity extends Entity {
  ...
  public draw(ctx: CanvasRenderingContext2D): void {
    ...
    ctx.fillRect(
      this.p.x + this.borderThickness,
      this.p.y + this.borderThickness,
      this.s.x - this.borderThickness * 2,
      this.s.y - this.borderThickness * 2,
    );
    ...
    ctx.fillText(
      ...
      this.p.y + this.s.y * 0.5 + this.fontSize * 0.3,
    );
