...
export class Dude extends Entity {
  ...
  public update(tick: number, mouse: Mouse): void {
    ...
    if (this.height > 0)
      this.height = clamp01(this.height - 0.0025 * this.delta);
  ...
  public draw(ctx: CanvasRenderingContext2D): void {
    ...
    ctx.translate(
      0,
      -18 + this.animationPhaseAbs * 7 - clamp01(this.air - 0.5) * 20,
    );
    ...
    ctx.bezierCurveTo(
      ...
      7,
      -25,
      15 - this.animationPhaseAbs * 2 - this.wave,
      -35,
    );
  ...
  private drawArm(
    ...
    if (dir < 0 || !this.cane) {
      this.curveTo(
        ctx,
        dir * 20 - this.wave * 5 + this.air * -10,
        -20 + diff * 1.2,
        dir * 15 + this.wave * 5,
        diff + this.air * -10,
      );
      ...
      this.curveTo(
        ctx,
        dir * 20 - this.wave * 10 + this.animationPhaseAbs * 3,
        5 + diff * 1.2 + yoff,
        20 * dir,
        -25 + diff + yoff,
      );
